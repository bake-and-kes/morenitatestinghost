...
function handleProductSnapshot(t, o=categoria) {
    ...
    const r = o
      , a = `\n<div class="galeria-imagenes">\n    <img src="${e.imagen}" alt="${e.nombre}" class="imagen-principal" id="imagenPrincipal">\n    <div class="miniaturas">\n        <img src="${e.imagen}" alt="${e.nombre}" class="miniatura" onclick="cambiarImagen(this.src)">\n        ${e.imagen2 ? `<img src="${e.imagen2}" alt="${e.nombre}" class="miniatura" onclick="cambiarImagen(this.src)">` : ""}\n        ${e.imagen3 ? `<img src="${e.imagen3}" alt="${e.nombre}" class="miniatura" onclick="cambiarImagen(this.src)">` : ""}\n    </div>\n</div>\n<div class="info-producto">\n    <h1 class="titulo">${e.nombre}</h1>\n    <p class="precio">$${formatearPrecio(e.precio)}</p>\n    <div class="descripcion">\n        <h2>Contenido</h2>\n        ${e.descripcion || "Sin descripción disponible"}\n    </div>\n    <div class="opciones">\n        <h3>El regalo lleva una carta personalizada, agrega tu mensaje al completar los datos del pedido</h3>\n    </div>\n    <button class="btn-comprar" onclick="agregarAlCarrito('${productoId}', '${e.nombre}', ${e.precio}, '${e.imagen}', '${r}')">Agregar al carrito</button>\n</div>\n`;
...
function cambiarImagen(t) {
    document.getElementById("imagenPrincipal").src = t
}
